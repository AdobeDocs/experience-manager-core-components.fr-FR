...
| `groupId` |  | ID de groupe Maven de base (par exemple, `"com.mysite"`). Cette valeur doit être [Nom de package Java valide.](https://docs.oracle.com/javase/specs/jls/se6/html/packages.html#7.7) |
...
|---------|---------|---------|---------|---------|
| [37](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-37) | Suite | 6.5.7.0+ | 8, 11 | 3.3.9+ |
