...
| `includeFormscommunications` | `n` | Inclut [Composants principaux de Forms](https://github.com/adobe/aem-core-forms-components) dépendances, modèles, modèles de données de formulaire, thèmes et génèrent les artefacts correspondants pour les programmes de communications Forms. |
| `includeFormsenrollment` | `n` | Inclut [Composants principaux de Forms](https://github.com/adobe/aem-core-forms-components) dépendances, modèles, modèles de données de formulaire, thèmes et génèrent les artefacts correspondants pour les programmes d’inscription Forms. |

## Configuration requise {#requirements}

| Archétype | AEM as a Cloud Service | AEM 6.5 | Java SE | Maven |
|---------|---------|---------|---------|---------|
| [32](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-32) | Suite | 6.5.7.0+ | 8, 11 | 3.3.9+ |
