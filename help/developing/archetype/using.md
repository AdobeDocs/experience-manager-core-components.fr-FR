...
>
>Un exemple de fichier POM [est disponible ici](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-17454.html?lang=fr).
...
| `enableDynamicMedia` | `n` | Active les composants Dynamic Media de base dans les paramètres de politiques de projet et active les fonctionnalités Dynamic Media dans les politiques du composant Image de base. |
...
* Tests Hobbes.js côté client : il s’agit de tests JavaScript côté navigateur qui vérifient le comportement côté navigateur. Pour tester :
   ...
   1. Ouvrez la page en [mode développeur](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developer-tools/developer-mode.html?lang=fr).
...
* [Adapter la structure de localisation](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/administering/reusing-content/translation/preparation.html?lang=fr)
