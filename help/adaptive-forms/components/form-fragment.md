...
description: Utilisez des fragments de formulaire pour créer des segments de formulaire ou des groupes de champs et les réutiliser dans Adaptive Forms afin d’améliorer l’efficacité et la réutilisation.
...
# Composant de fragment de formulaire {#form-fragment-component-adaptive-forms-core-component}

Les Forms adaptatives offrent un moyen pratique de créer des segments de formulaire, tels que des panneaux ou des groupes de champs, afin qu’ils puissent être réutilisés dans différentes Forms adaptatives. Ces segments réutilisables et autonomes sont appelés [Fragments de formulaire adaptatif](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/adaptive-form-fragments-core-components.html).

Vous pouvez [ajout d’un fragment plusieurs fois à un document](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/adaptive-form-fragments-core-components.html#insert-a-fragment-in-an-adaptive-form) et utiliser les propriétés de liaison de données de ses composants pour les lier à différentes sources de données ou différents schémas. Par exemple, vous pouvez utiliser le même fragment d’adresse pour les adresses permanentes, de communication et de facturation et le connecter à différents champs d’une source de données ou d’un schéma.

![exemple](/help/adaptive-forms/assets/using-multiple-fragment-af.gif)


Vous pouvez également utiliser la variable [option de répétabilité](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/create-forms-repeatable-sections.html?lang=fr) pour dupliquer le composant de fragment de formulaire et ses composants enfants, définissez un nombre de répétitions minimal et maximal et facilitez la réplication de sections similaires dans un formulaire.

>[!NOTE]
>
> Vous pouvez [création d’un fragment de formulaire adaptatif](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/adaptive-form-fragments-core-components.html#create-a-fragment) à partir de zéro ou enregistrez un panneau dans un formulaire adaptatif existant en tant que fragment.

## Utilisation {#usage}

- **Réutilisation**: la possibilité de réutiliser des fragments de formulaire sur plusieurs Forms adaptatives constitue le principal avantage de l’utilisation de fragments de formulaire. Cela permet de maintenir la cohérence de la conception et des fonctionnalités, car les modifications apportées à un fragment sont répercutées dans toutes les instances où il est utilisé.

- **Expérience utilisateur cohérente**: l’utilisation de fragments de formulaire pour les éléments communs (en-têtes ou pieds de page, par exemple) garantit une expérience utilisateur cohérente et cohérente.

- **Maintenance aisée**: les modifications apportées à un fragment de formulaire sont répercutées dans toutes les instances où il est utilisé. Cela simplifie la maintenance et réduit les risques d’erreurs.

- **Efficacité**: les concepteurs et les développeurs gagnent du temps en créant et en testant des fragments de formulaire une seule fois. Les fragments de formulaire peuvent ensuite être facilement intégrés à plusieurs Forms adaptatives sans nécessiter de travail redondant.

## Version et compatibilité {#version-and-compatibility}

Le composant principal de fragment de Forms adaptatif a été publié dans le cadre des composants principaux 2.0.50 pour Cloud Service et des composants principaux 1.1.26 pour AEM 6.5.16.0 Forms ou version ultérieure. Vous trouverez ci-dessous un tableau détaillant les versions prises en charge, la compatibilité avec AEM et les liens vers la documentation correspondante :

| Version du composant | AEM as a Cloud Service | AEM 6.5.16.0 Forms ou version ultérieure |
|---|---|---|
| v1 | Compatible avec la <br>[version 2.0.50](/help/adaptive-forms/version.md) et les versions ultérieures | Compatible avec<br>[version 1.1.26](/help/adaptive-forms/version.md) et plus tard, mais moins de 2.0.0. |

Pour plus d’informations sur les versions et publications des composants principaux, consultez le document [Versions des composants principaux](/help/adaptive-forms/version.md).

## Détails techniques {#technical-details}

Découvrez les informations les plus récentes sur le composant principal de fragment de Forms adaptatif dans la documentation technique de [GitHub](https://github.com/adobe/aem-core-forms-components/tree/master/ui.af.apps/src/main/content/jcr_root/apps/core/fd/components/form/fragment). Pour plus d’informations sur le développement des composants principaux, consultez la [documentation destinée aux développeurs et développeuses de composants principaux](/help/developing/overview.md).

## Boîte de dialogue de configuration {#configure-dialog}

Vous pouvez facilement personnaliser votre expérience de fragment pour les visiteurs qui utilisent la boîte de dialogue Configurer . Vous pouvez également définir facilement des propriétés de fragment pour une expérience utilisateur transparente.
...
- **Référence de fragment** - Une référence à un fragment est une référence à un fragment de formulaire stocké dans une source de données externe et utilisé dans un formulaire. La référence au fragment vous permet de lier dynamiquement le fragment de formulaire à un formulaire.
...
- **Rendre le fragment répétable**: fonction de basculement qui permet aux utilisateurs d’activer ou de désactiver la fonctionnalité de répétabilité.
- **Répétition minimale**: définit le nombre minimal de répétitions du composant de fragment. La valeur zéro indique que le composant de fragment n’est pas répété ; la valeur par défaut est zéro.
...
La boîte de dialogue de conception permet de définir et de gérer les styles CSS du composant de fragment de formulaire.

### Onglet Styles {#styles-tab}

Le composant principal Fragment de formulaire adaptatif prend en charge l’AEM [Système de style](/help/get-started/authoring.md#component-styling).

![Boîte de dialogue de conception](/help/adaptive-forms/assets/checkbox-style.png)

- **Classes CSS par défaut**: vous pouvez fournir une classe CSS par défaut pour le composant principal Fragment de formulaire adaptatif.
