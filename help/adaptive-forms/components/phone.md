---
title: Composant principal Adaptive Forms - Entrée téléphone, Téléphone
...
Cet onglet vous permet de définir et de gérer les styles CSS d’un composant. Le composant principal Téléphone de Forms adaptatif prend en charge l’AEM [Système de style](/help/get-started/authoring.md#component-styling).

![Boîte de dialogue de conception](/help/adaptive-forms/assets/telephoneinput_designdialog.png)

- **Classes CSS par défaut**: vous pouvez fournir une classe CSS par défaut pour le composant principal Téléphone du Forms adaptatif.
