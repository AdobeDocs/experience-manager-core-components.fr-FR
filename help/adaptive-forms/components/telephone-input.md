...
Le panneau Modèle de validation permet de saisir des valeurs dans un format spécifique ou de répondre à certains critères. Certaines options sont disponibles par défaut, que vous pouvez sélectionner en cochant la case correspondante. En outre, vous pouvez ajouter un format personnalisé en cliquant sur le **Ajouter** bouton .
