...
Le composant principal Fragment des formulaires adaptatifs a été publié au sein des composants principaux 2.0.50 pour Cloud Service et des composants principaux 1.1.26 pour AEM 6.5.16.0 Forms ou version ultérieure. Vous trouverez ci-dessous un tableau détaillant les versions prises en charge, la compatibilité avec AEM et les liens vers la documentation correspondante :
