...
|---|---|---|---|---|
| [2.0.74](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.74) | Avec cette version, l’erreur d’envoi est mise à jour pour l’action Envoyer dans AEM Forms. | En continu | 8, 11 | 15 novembre 2023 |
...
| [2.0.64](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.64) | Prise en charge du texte enrichi pour les libellés des composants de case à cocher/radio. Cette version comprend également des correctifs pour le composant Termes et conditions . | En continu | 8, 11 | 6 novembre 2023 |
| [2.0.62](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.62) | Avec cette version, la prise en charge du composant Termes et conditions est ajoutée. Ajout également de la prise en charge du nom qualifié dans les composants principaux. | En continu | 8, 11 | 16 octobre 2023 |
| [2.0.60](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.60) | Cette version comprend des correctifs relatifs aux propriétés personnalisées, aux composants Assistant et Sélecteur de date. | En continu | 8, 11 | 12 septembre 2023 |
...
| [2.0.48](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.48) | Les principales améliorations apportées à cette version sont liées aux performances de Lighthouse. | En continu | 8, 11 | 25 juillet 2023 |
...
| [2.0.36](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.36) | Avec cette version, vous pouvez utiliser le gestionnaire d’erreurs personnalisé à l’aide du service d’appel de l’éditeur de règles. | En continu | 8, 11 | 3 juillet 2023 |
...
|---|---|---|---|---|---|
| [1.1.32](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-1.1.32) | Cette version a mis à jour les informations relatives aux packages du Service Pack AEM 6.5.18.0. | - | 6.5.16.0 et version ultérieure | 8, 11 | 15 octobre 2023 |
| [1.1.28](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-1.1.28) | Prise en charge du texte enrichi pour les libellés des composants de case à cocher/radio. Cette version comprend également la prise en charge du composant Termes et conditions . | - | 6.5.16.0 et version ultérieure | 8, 11 | 15 octobre 2023 |
| [1.1.26](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-1.1.26) | Avec cette version, la prise en charge du composant de case à cocher pour le formulaire adaptatif a été ajoutée. Elle comprend également des améliorations des performances de Lighthouse. Le gestionnaire d’erreurs personnalisé à l’aide du service d’appel de l’éditeur de règles est également inclus dans cette version. | - | 6.5.16.0 et version ultérieure | 8, 11 | 15 octobre 2023 |
| [1.1.24](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-1.1.24) | Ajout de la prise en charge de la localisation des messages d’erreur par défaut, ainsi que du bouton Ajouter/Supprimer pour le composant Répétable. Ajout également de la prise en charge du recaptcha dans les Forms adaptatives. | - | 6.5.16.0 et version ultérieure | 8, 11 | 29 juin 2023 |
