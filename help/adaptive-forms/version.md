...
|---|---|---|---|---|
| [2.0.74](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.74) | Avec cette erreur d’envoi de version, est mise à jour pour l’action Envoyer dans AEM Forms. | En continu | 8, 11 | 15 novembre 2023 |
...
| [2.0.18](https://github.com/adobe/aem-core-forms-components/releases/tag/core-forms-components-reactor-2.0.18) | Avec cette version, la prise en charge d’une répétition pour le composant Accordéon. | En continu | 8, 11 | 5 juin 2023 |
