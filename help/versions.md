...
|---|---|---|---|---|---|---|
| [2.16.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.16.0) | Cette version s’est concentrée sur les améliorations d’accessibilité et sur l’introduction d’un nouveau gestionnaire de liens aux composants existants. | 6.4.8.1+ * | 6.5.5.0+ * | Suite | 8, 11 | 22 avril 2021 |
