...
Les largeurs d’image autorisées ainsi que le recadrage et les paramètres supplémentaires peuvent être définis par l’auteur du modèle dans la [boîte de dialogue de conception](image-v1.md#main-pars_title_1995166862). L’éditeur de contenu peut télécharger ou sélectionner des ressources dans la [boîte de dialogue de configuration](image-v1.md#main-pars_title_55926120) et recadrer l’image dans la [boîte de dialogue de modification](image-v1.md#main-pars_title). Pour plus de commodité, une simple modification statique de l’image est également disponible.
...
>
>Pour plus d’informations sur la version actuelle du composant d’image, voir le document [Composant d’image](image.md).
...
Outre la [boîte de dialogue de modification](image-v1.md#main-pars_title) et la [boîte de dialogue de conception](image-v1.md#main-pars_title_1995166862) standard, le composant d’image propose une boîte de dialogue de configuration dans laquelle l’image elle-même est définie avec sa description et ses propriétés de base.
...
Vous trouverez la documentation technique la plus récente sur le composant d’image [sur GitHub](https://github.com/adobe/aem-core-wcm-components/tree/master/content/src/content/jcr_root/apps/core/wcm/components/image/v1/image).
