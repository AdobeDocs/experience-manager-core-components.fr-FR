...
+ Composants de gestion de contenu web {#wcm-components}
  ...
  + Composants v2 {#v2-components}
    ...
    + [Recherche rapide (v2)](/help/components/v2/quick-search.md)
...
+ Formulaires adaptatifs {#adaptive-forms}
  ...
  + Composants des formulaires adaptatifs {#adaptive-forms-components}
    ...
    + [Formulaires adaptatifs - Date et heure](/help/adaptive-forms/components/date-time-component.md)
    ...
    + {hide-from-toc}[Choix d’image du Forms adaptatif](/help/adaptive-forms/components/image-choice.md)
  ...
  + {hide-from-toc}[Activer les modèles de validation d’entrée de texte](/help/adaptive-forms/enable-validation-patterns.md)
