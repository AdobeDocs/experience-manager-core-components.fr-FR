...
>[!TIP]
>
>Les options **Recadrage intelligent** et **Paramètre d’image prédéfini** s’excluent mutuellement. Si un auteur ou une autrice doit utiliser un paramètre d’image prédéfini associé à un rendu avec recadrage intelligent, il ou elle doit utiliser les **modificateurs d’image** pour ajouter manuellement ce paramètre.
