...
>Pour plus d’informations sur la version actuelle du composant Recherche rapide, voir [Composant Recherche rapide](/help/components/quick-search.md) document.
