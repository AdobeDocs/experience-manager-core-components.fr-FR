...
La version actuelle du composant de partage sur les réseaux sociaux est la version 1, qui a été introduite avec la version 1.0.0 des composants principaux, et est décrite dans ce document.
